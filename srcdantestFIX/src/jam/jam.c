...
{ /* Kamus Lokal */
    Jam J1;
    /* Algoritma */
    Hour(J1) = H; Minute(J1) = M; Second(J1) = S; return J1;
}
...
{ /* Kamus Lokal */
    ...
    do {
        printf("Masukkan jam : ");
        scanf("%d",&H); printf("Masukkan menit : ");
        scanf("%d",&M); printf("Masukkan detik : ");
        scanf("%d",&S);
...
void TulisJam(Jam J)
/* I.S. : J sembarang*/
/* F.S. : J ditulis ke layar dengan format HH:MM:SS */ /* Proses : Menulis ke layar */
{ /* Kamus lokal */
/* Algoritma */
